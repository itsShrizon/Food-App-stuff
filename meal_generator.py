...
from app.services.meal_generator import (
    generate_meal,
    generate_day_meals,
    generate_day_meals as generate_daily_meal_plan,
    generate_meal_plan,
    VALID_MEAL_TYPES,
...
# Re-export internal helpers for any legacy code that might use them
from app.services.meal_generator.utils import calculate_age as _calculate_age
from app.services.meal_generator.utils import ensure_meal_schema as _ensure_meal_schema

# Legacy prompts (for any code that imported these directly)
from app.services.meal_generator.config import MEAL_GENERATION_SYSTEM_PROMPT
from app.services.meal_generator.config import DAILY_MEAL_SYSTEM_PROMPT as DAILY_MEAL_GENERATION_SYSTEM_PROMPT
